...
Gage: Figured it out. If we knit to pdf in the file "xtable_code.Rmd", we can get the table. I also took a screenshot of the table and put it in our project file. All we need to do is add the screenshot of the table for our final word document. 
...
The mean lobster size at Isla Vista(Marine Protected Area) in 2012 (66.08 ±  mm [mean±sd], n= ) and 2017 (71.45 ±  mm [mean±sd], n= ) did not differ significantly based on a two-sample Student’s t-test (t(630) = -1.885, p = 0.0599, α = 0.05). Also, the effect size is small (Cohen’s d = -0.38) and the absolute difference in mean lobster size between the two years is 5.375 mm.
...
```
The mean lobster size at Naples Reef(Marine Protected Area) in 2012 (73.00 ±  mm [mean±sd], n= ) and 2017 ( 76.23±  mm [mean±sd], n= ) did not differ significantly based on a two-sample Student’s t-test (t(116) = -0.676, p = 0.05002, α = 0.05).

Even though p-value is low??? close to significant?- the effect size is small (Cohen’s d = -0.28) and the absolute difference in mean lobster size between two years is only 3.232 mm.
